...
// Option 2: callback
const dispose = when(() => obs.ok, () => console.log("Don't worry, it's ok"))
...
const computed = computed(() => obs.test + obs.test2)
// computed.get() === 30
