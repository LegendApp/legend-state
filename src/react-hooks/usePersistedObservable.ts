import { ObservableNode, ObservableObject, ObservablePersistState, PersistOptions } from '@legendapp/state';
...
): [ObservableNode<T>, ObservableObject<ObservablePersistState>] {
